...
try {
  const response = await fetch('https://api.anthropic.com/v1/messages', {
    ...
    body: JSON.stringify({
      ...
      Professional Competencies (Leadership, Strategic Thinking, Communication, Analytical Thinking, Emotional Intelligence, Problem Solving, Change Management, Coaching, Decision Making, etc.)
Neurodynamic Performance Indicators (High Performance Energy, Connectors, Transformers, Innovators, Rhythms)
Interview Positioning (how to articulate this professionally)

Strengths:
${validStrengths.map((s, i) => ${i + 1}. ${s.description}).join('\n')}
...
<description>Creating complete strengths module file using bash heredoc</description>
</tool_use>
<tool_use name="bash_tool">
<command>wc -l /mnt/user-data/outputs/strengths-page-complete.tsx && ls -lh /mnt/user-data/outputs/strengths-page-complete.tsx</command>
<description>Verifying the complete file was created</description>
</tool_use>
<tool_use name="present_files">
<filepaths>/mnt/user-data/outputs/strengths-page-complete.tsx</filepaths>
</tool_use>
